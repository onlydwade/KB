...
import com.bytefinger.toutuo.biz.workbrief.mapper.RecentProjectWinBidderMapper;
...
public class RecentProjectWinBidderServiceImpl extends BizService<RecentProjectWinBidderMapper, RecentProjectWinBidder> implements IRecentProjectWinBidderService, ThisService<RecentProjectWinBidderServiceImpl> {
...
//    private Long headquartersCode;
    ...
    @Override
    public List<RecentProjectWinBidder> getListByBriefId(Long briefId) {
    ...
    @DataFill
    @Override
    public List<RecentProjectWinBidder> getList(QueryPage queryPage) {
        // 近两周时间运算
