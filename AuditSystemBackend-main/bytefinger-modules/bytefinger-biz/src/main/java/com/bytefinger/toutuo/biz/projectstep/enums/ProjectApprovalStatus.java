package com.bytefinger.toutuo.biz.projectstep.enums;
...
public enum ProjectApprovalStatus {
    ...
    ProjectApprovalStatus(Integer code, String desc) {
        this.code = code;
        this.desc = desc;
    }

    public static ProjectApprovalStatus getByCode(int code) {
        for (ProjectApprovalStatus value : ProjectApprovalStatus.values()) {
    ...
    public static ProjectApprovalStatus isExpire(int code) {
