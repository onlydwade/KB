 ...
 */
@Data
@TableName("biz_recent_project_win_bidder")
@ApiModel(value = "近期项目中标情况", description = "近期项目中标情况")
public class RecentProjectWinBidder extends BaseEntity {
    ...
    @ApiModelProperty(value = "年饱和收入(亿)")
    @TableField("annual_saturated_income")
    private String annualSaturatedIncome;
