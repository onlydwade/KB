...
@TableName("biz_project_extension_oper_log")
@ApiModel(value = "ProjectExtensionOperLog对象", description = "拓后业务数据变更记录表")
public class ProjectExtensionOperLog extends BaseEntity {
