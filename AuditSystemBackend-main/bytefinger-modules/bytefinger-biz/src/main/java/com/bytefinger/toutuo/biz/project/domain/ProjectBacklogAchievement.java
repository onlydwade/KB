...
@TableName("biz_project_backlog_achievement")
@ApiModel(value = "ProjectBacklogAchievement对象", description = "项目补录业绩分配")
public class ProjectBacklogAchievement extends BaseEntity {
     ...
     * 是否删除 0-否 1-是
     */
    @ApiModelProperty(value = "是否删除 0-否 1-是", hidden = false, required = false)
    @TableField(exist = false)
    @HistoryFieldLog("是否删除 0-否 1-是")
    @Excel(name = "是否删除 0-否 1-是")
    private Integer deleted;


    @ApiModelProperty(value = "公司父级id", hidden = false, required = false)
    @TableField(exist = false)
