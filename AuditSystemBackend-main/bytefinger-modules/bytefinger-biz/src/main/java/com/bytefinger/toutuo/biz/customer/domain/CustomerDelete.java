...
@Data
@TableName("biz_customer_delete")
@ApiModel(value = "客户删除对象", description = "客户删除表")
public class CustomerDelete extends TimeBaseEntity {
    ...
    @ApiModelProperty(value = "是否恢复（0：否，1：是）", hidden = false, required = false)
    @TableField("is_recover")
    @Dict(type = "SHI_FOU")
    @HistoryFieldLog("是否恢复（0：否，1：是）")
