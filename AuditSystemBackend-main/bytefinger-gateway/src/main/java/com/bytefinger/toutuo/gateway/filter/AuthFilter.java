...
import com.bytefinger.common.core.constant.TokenConstants;
...
import com.bytefinger.toutuo.gateway.config.properties.IgnoreWhiteProperties;
...
public class AuthFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        try {
            ...
            log.error("登录状态已过期的令牌：" + e.getMessage());
            return unauthorizedResponse(exchange, "登录状态已过期");
        }
        ...
        addHeader(mutate, SecurityConstants.DETAILS_REALNAME, realname);
