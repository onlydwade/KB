...
import { useCorrelation } from './correlationUndertaking';
...
const handleChange = (val) => {
    ...
    if (findItem) {
        ...
        editData['add'].contractAmount = findItem.contractAmount
        editData['add'].contractAnnualAmount = findItem.contractAnnualAmount
