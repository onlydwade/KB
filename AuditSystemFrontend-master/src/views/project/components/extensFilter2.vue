  ...
  <div class="filter-box">
    <a-form :label-col="{ style: { width: '110px' } }" ref="formRef" :model="formData">
      <a-row :class="{ 'show_more_col': formData.moreFilter }">
        ...
        <a-col :span="6" class="more_col">
          <a-form-item label="同步到拓后运营" name="isSyncOperation">
            <a-select v-model:value="formData.isSyncOperation" max-tag-count="responsive" class="w_full" placeholder="请选择"
              :options="dict.optionsAll('SHI_FOU')">
            </a-select>
          </a-form-item>
        </a-col>
        <a-divider v-if="formData.moreFilter" style="margin: 5px 0px; font-size: 13px;" orientation="left"></a-divider>
        <a-col :span="6" class="more_col">
          <a-form-item label="状态" name="serviceStatus">
            <a-select :disabled="true" mode="multiple" max-tag-count="responsive" v-model:value="formData.serviceStatus"
        ...
        <a-col :span="6" class="more_col">
          <a-form-item label="项目状态" name="expandServiceStatus">
            <a-select mode="multiple" :disabled="true" max-tag-count="responsive"
              v-model:value="formData.expandServiceStatus" class="w_full" placeholder="请选择"
        ...
        <a-col :span="12" class="more_col">
          <a-form-item label="年内状态变为" name="expandTwoServiceStatus">
            <a-select mode="multiple" max-tag-count="responsive" v-model:value="formData.expandTwoServiceStatus"
              class="w_full" placeholder="请选择" allowClear :options="expandTwoServiceStatus">
            </a-select>
          </a-form-item>
        </a-col>
        ...
        <a-col :span="formData.moreFilter ? 24 : 18" class="text-right">
          <a-form-item name="searchKey">
            <a-space>
              ...
              <a-button type="text" @click="unfold">{{ formData.moreFilter ? '收起' : '展开' }}</a-button>
            </a-space>
          </a-form-item>
        </a-col>
      </a-row>
...
const clearText = () => {
  ...
  // formData.moreFilter = !formData.moreFilter;
  // formData.searchKey = '';
}
</script>
