            ...
            <template #bodyCell="{ column, text, record, index }">
                ...
                <template v-if="column.key === 'action'">
                    <template v-if="!editData[index]">
                        ...
                        <!-- <a-button type="text" class="color-primary" v-if="!readOnly" size="small" @click="clone(record,index)">克隆</a-button> -->
                    </template>
                    <a-space v-else>
...
const {
    ...
    del,
    clone
} = useCorrelation(props.projectId, 'projectManagementIndicators');
