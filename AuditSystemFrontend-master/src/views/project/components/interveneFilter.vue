    ...
    >
      <a-row :class="{ show_more_col: formData.moreFilter }">
        ...
        <a-col :span="6">
          <a-form-item
            label="是否已下达方案"
            name="isNotTransmitInterveneScheme"
          >
            <a-select
              v-model:value="formData.isNotTransmitInterveneScheme"
              class="w_full"
              placeholder="请选择"
              :options="isNotTransmitInterveneScheme"
            >
            </a-select>
          </a-form-item>
        </a-col>
        <a-col :span="6" class="more_col">
          <a-form-item label="最新方案执行状态" name="interveneState">
            <a-select
              v-model:value="formData.interveneState"
              class="w_full"
              placeholder="请选择"
              :options="interveneState"
            />
          </a-form-item>
        </a-col>
        <a-col :span="6" class="more_col">
...
const isNotTransmitInterveneScheme = reactive([
  {
    value: "",
    label: "全部",
  },
