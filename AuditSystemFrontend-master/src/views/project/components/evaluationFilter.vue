  ...
  <div class="filter-box">
    ...
    >
      <a-row :class="{ show_more_col: formData.moreFilter }">
        ...
        <a-col :span="6">
          <a-form-item label="是否已评估" name="assessState">
            <a-select
              v-model:value="formData.assessState"
              class="w_full"
              placeholder="请选择"
              :options="options"
              allowClear
        ...
        <a-col :span="6" class="more_col">
          <a-form-item label="经营评估期限" name="assessDeadline">
            <a-date-picker
              allowClear
              v-model:value="formData.assessDeadline"
              class="w_full"
        ...
        <a-col :span="6" class="more_col">
          <a-form-item label="拓后负责人" name="principalId">
            <UserSelect v-model="formData.principalId" />
          </a-form-item>
        </a-col>
        <!-- <a-col :span="6" class="more_col">
          <a-form-item label="省份" name="pro">
            <a-input
              allowClear
              v-model:value="formData.pro"
              placeholder="请输入"
            />
          </a-form-item>
        </a-col>
        <a-col :span="6" class="more_col">
          <a-form-item label="城市" name="cs">
            <a-input
              allowClear
              v-model:value="formData.cs"
              placeholder="请输入"
            />
          </a-form-item>
        </a-col>
        <a-col :span="6" class="more_col">
          <a-form-item label="区/县" name="qx">
            <a-input
              allowClear
              v-model:value="formData.qx"
              placeholder="请输入"
            />
          </a-form-item>
        </a-col> -->
