...
<template>
    ...
    <evaluateDrawer ref="drawerRef" :companyId="companyId" :menuId="menuInfo.id" @success="getPage"/>
</template>
<script setup>
import api                 from '@/api/index';
import evaluateDrawer      from '../evaluateDrawer.vue';
...
const getPage = ()=>{
    ...
    loadding.value = true;
    api.investment.correlationPage(postData,'companyAppraise',props.menuInfo.id).then(res=>{
        if(res.code==200){
